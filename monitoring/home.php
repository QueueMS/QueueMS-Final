                    ...
                    <div class="card-body h-100">
                        <div id="serving-list" class="list-group overflow-auto">
                            ...
                            <div class="list-group-item" data-id="<?php echo $row['cashier_id'] ?>" style="display:none">
                                ...
                                <div class="ps-4"><span class="serve-queue fs-4 fw-bold" style="color: #bc6e19;">1001 - John Smith</span></div>
                            </div>
                            <?php endwhile; ?>
                        </div>
                    </div>
...
<script>
    ...
    ampm = hour >= 12 ? "PM" : "AM";
    mo = months[datetime.getMonth()];
    d = datetime.getDate(); // Get the day of the month
