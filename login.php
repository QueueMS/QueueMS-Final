...
<head>
    ...
    <title>LOGIN | BigBrew Cashier Queuing System</title>
    ...
    <style>
        html, body{
            height:100%;
            background-color: #bc6e19; /* Set background color */
        }
...
<body>
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light"> BigBrew Cashier Queuing System</h3>
            ...
            <div class="card-body">
                <form action="" id="login-form">
                    ...
                    <div class="form-group d-flex w-100 justify-content-between align-items-center">
                        ...
                        <!-- Updated button with custom styles -->
                        <button class="btn btn-sm btn-dark rounded-0 my-1">Login</button>
                    </div>
                </form>
            </div>
        </div>
