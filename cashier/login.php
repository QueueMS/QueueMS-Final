...
<head>
    ...
    <title>LOGIN | BigBrew Cashier Queuing System - Cashier - Side</title>
    ...
    <style>
        ...
        .bg-custom {
            background-color: #bc6e19; /* Background color */
        }
...
<body class="bg-custom">
   <div class="h-100 d-flex justify-content-center align-items-center">
       <div class="w-100">
        <h3 class="py-5 text-center text-light">BigBrew Cashier Queuing System - Cashier Side</h3>
            ...
            <div class="card-body">
                <form action="" id="login-form">
                    ...
                    <div class="form-group d-flex w-100 justify-content-between align-items-center">
                        <a href="./../">Admin</a>
                        <button class="btn btn-sm btn-black rounded-0 my-1">Login</button>
                    </div>
                </form>
            </div>
        </div>
