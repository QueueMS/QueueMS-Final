...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | BigBrew Cashier Queuing System - Cashier - Side</title>
...
<body>
    <main>
    <nav class="navbar navbar-expand-lg navbar-dark bg-custom bg-gradient" id="topNavBar">
        <div class="container">
    ...
    <div class="modal fade" id="uni_modal_secondary" role='dialog' data-bs-backdrop="static" data-bs-keyboard="true">
        ...
        <div class="modal-footer py-1">
            <button type="button" class="btn btn-sm rounded-0 btn-primary" id="submit" onclick="$('#uni_modal_secondary form
